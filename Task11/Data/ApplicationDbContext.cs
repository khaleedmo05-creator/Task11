...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.BrandId).HasName("PK__brands__5E5A8E27F9CC728D");
        });

        modelBuilder.Entity<Category>(entity =>
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__categori__D54EE9B4FA7CD171");
        });

        modelBuilder.Entity<Customer>(entity =>
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__customer__CD65CB855DCE1E74");
        });

        modelBuilder.Entity<Employee>(entity =>
        {
            entity.ToTable(tb => tb.HasTrigger("trigger_1"));
        ...
        {
            entity.HasKey(e => e.LogId).HasName("PK__logs__9E2397E0B0249837");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__orders__4659622992F3F0E8");
        ...
        {
            entity.HasKey(e => new { e.OrderId, e.ItemId }).HasName("PK__order_it__837942D4C46D13EC");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__products__47027DF5186F9951");
        ...
        {
            entity.HasKey(e => e.StaffId).HasName("PK__staffs__1963DD9CF5339194");
        ...
        {
            entity.HasKey(e => new { e.StoreId, e.ProductId }).HasName("PK__stocks__E68284D307F020AD");
        ...
        {
            entity.HasKey(e => e.StoreId).HasName("PK__stores__A2F2A30CA5222130");
        });
